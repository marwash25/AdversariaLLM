...
from llm_quick_check.run_judges import run_judges_main as run_judges
from llm_quick_check.attacks import Attack, AttackResult
from llm_quick_check.dataset import PromptDataset
from llm_quick_check.errors import print_exceptions
from llm_quick_check.io_utils import (RunConfig, filter_config, free_vram, load_model_and_tokenizer,
...
@print_exceptions
def run_attacks_main(cfg: DictConfig) -> None:
